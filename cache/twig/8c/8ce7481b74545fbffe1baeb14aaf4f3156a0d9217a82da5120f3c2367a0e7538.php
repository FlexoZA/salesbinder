...
{% if value %}
    ...
    {% endif %}
{% endif %}
{% endblock %}", "forms/fields/conditional/conditional.html.twig", "/home/christiaan/projects/salesbinder/user/plugins/form/templates/forms/fields/conditional/conditional.html.twig");
    }
}
